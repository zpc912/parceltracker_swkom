...
public class WarehouseEntity extends HopEntity {
    ...
    @Builder
    public WarehouseEntity( List<WarehouseNextHopsEntity> nextHops, Integer level, String code, String hopType, String description, Integer processingDelayMins, String locationName, GeoCoordinateEntity locationCoordinates ) {
        super(code, description, hopType, processingDelayMins, locationName, locationCoordinates);
